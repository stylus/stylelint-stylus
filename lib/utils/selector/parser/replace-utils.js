 ...
 * @param {SelectorReplacer[]} regexps text regexps
 * @param {SelectorReplacer[]} commentRegexps comment regexps
 * @param {SelectorReplacer[]} trivialRegexps
