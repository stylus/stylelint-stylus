...
const { optionsMatches, isString } = require("../../option")
const { removeEmptyLinesBefore, addEmptyLineBefore } = require("../../fix")
...
const rule = (primary, secondaryOptions, context) => {
    return (root, result) => {
        ...
        root.walkAtRules((atRule) => {
            ...
            if (
                optionsMatches(secondaryOptions, "ignoreAtRules", atRule.name)
            ) {
                return
            }
            ...
            if (
                optionsMatches(secondaryOptions, "ignore", "first-nested") &&
            ...
            if (
                optionsMatches(secondaryOptions, "ignore", "inside-block") &&
                isNested
            ) {
                return
            }
            ...
            if (
                optionsMatches(secondaryOptions, "ignore", "after-comment") &&
            ...
            if (
                ...
                (optionsMatches(secondaryOptions, "except", "inside-block") &&
                    isNested) ||
                (optionsMatches(secondaryOptions, "except", "first-nested") &&
                    isFirstNested(atRule)) ||
                (optionsMatches(
                    secondaryOptions,
                    "except",
